            ...
            data: {
                ...
                attributes: {
                    ...
                    properties: {
                        ...
                        ProductName: getLocalizedStringAsText(lineItem.name),
                        Quantity: lineItem.quantity,
                        ItemPrice: getTypedMoneyAsNumber(lineItem.price?.value),
                        RowTotal: getTypedMoneyAsNumber(lineItem.totalPrice),
                    } as any,
